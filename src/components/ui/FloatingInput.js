  ...
  return (
    <div className=" flex flex-col justify-center w-full relative mb-2 ">
      <input
        ...
        className="flex-1 appearance-none bg-slate-50 rounded p-2.5 mt-2 text-sm w-full peer border border-slate-300 placeholder-transparent  shadow-sm focus:rounded-md focus:border-yellow-650 focus:outline-none focus:border-0 focus:border-b"
        autoComplete="off"
        value={inputValue}
